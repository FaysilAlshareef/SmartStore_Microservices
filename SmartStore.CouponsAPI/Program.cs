...
using SmartStore.CouponsAPI.Helpers;
using SmartStore.CouponsAPI.Repository;

namespace SmartStore.CouponsAPI
{
    public class Program
    {
        public static void Main(string[] args)
        {
            ...
            builder.Services.AddScoped(typeof(CouponResponseDto));
            ...
            {
                c.SwaggerDoc("v1", new OpenApiInfo() { Title = "SmartStore.CouponsAPI" });
